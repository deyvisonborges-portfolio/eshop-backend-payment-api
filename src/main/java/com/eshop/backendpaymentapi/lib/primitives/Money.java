...
public final class Money {
	...
	public Money(float money) {
		if (money < 0) throw new IllegalArgumentException("Money cannot be less than zero.");
		if (money > MAX_VALUE) throw new IllegalArgumentException("Money cannot be greater than " + MAX_VALUE + ".");
		this.money = money;
	}
